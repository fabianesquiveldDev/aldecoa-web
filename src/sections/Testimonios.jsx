  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-8">
        ...
        {/* titulo */}
        <h2 className="text-3xl md:text-5xl font-black font-headline text-white text-center mb-10 md:mb-16 uppercase leading-tight">
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-8">
          {testimonios.map((testimonio) => (
            <div
              key={testimonio.id}
              className="bg-surface-container p-6 md:p-10 border-t-4 border-red-600 relative"
            >
              {/* icono comillas */}
              <span className="material-symbols-outlined text-red-600 text-5xl absolute -top-3 right-6 opacity-20">
                format_quote
              </span>

              {/* texto */}
              <p className="text-on-background/80 mb-6 md:mb-8 leading-relaxed text-sm md:text-base">
