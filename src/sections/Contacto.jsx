...
const INPUT_CLS =
  "w-full bg-surface-container-highest border-b-2 border-outline-variant focus:border-primary-container focus:ring-0 transition-colors text-white py-3 px-4 outline-none text-sm md:text-base";
...
export default function Contacto() {
  ...
  const SOCIALS = [
    {
      href: "#",
      label: "TikTok de ALDECOA 360",
      external: false,
      svg: "M19.589 6.686a4.793 4.793 0 0 1-3.77-1.862V14.1a5.109 5.109 0 1 1-5.109-5.109c.178 0 .355.01.528.03v2.57a2.54 2.54 0 1 0 2.54 2.54V0h2.54a4.79 4.79 0 0 0 3.27 4.59v2.096z",
    },
    {
      href: "#",
      label: "Instagram de ALDECOA 360",
      external: false,
    ...
    },
    {
      ...
      label: "YouTube de ALDECOA 360",
      external: true,
      svg: "M23.5 6.2a2.99 2.99 0 0 0-2.1-2.1C19.5 3.5 12 3.5 12 3.5s-7.5 0-9.4.6A2.99 2.99 0 0 0 .5 6.2C0 8.1 0 12 0 12s0 3.9.5 5.8a2.99 2.99 0 0 0 2.1 2.1c1.9.6 9.4.6 9.4.6s7.5 0 9.4-.6a2.99 2.99 0 0 0 2.1-2.1c.5-1.9.5-5.8.5-5.8s0-3.9-.5-5.8zM9.5 15.5v-7l6 3.5-6 3.5z",
    },
  ];
  ...
  const enviarWhatsApp = (e) => {
    ...
    const texto = `
Hola ALDECOA 360, me gustaría más información sobre sus servicios.
...
Mensaje:
${form.mensaje || "Me gustaría recibir más información."}
`.trim();
  ...
  const services = servicesData.servicios.map(
    ({ id_seccion, nombreSeccion: title, icon, slug }) => ({
      id_seccion,
      title,
      icon,
      slug,
            ...
            <div>
              ...
              <address className="not-italic space-y-4 md:space-y-6">
                {[
                  ...
                  <ContactIcon
                    ...
                    icon={
                      <span
                        aria-hidden="true"
                        className="material-symbols-outlined text-red-600 group-hover:text-white text-xl md:text-2xl"
                      >
                        {icon}
                      </span>
                    }
                ...
                <div className="flex gap-3 md:gap-4 pt-2 md:pt-4">
                  {SOCIALS.map(({ href, label, svg, external }) => (
                    <a
                      key={label}
                      href={href}
                      aria-label={label}
            ...
            <div className="bg-surface-container-high p-6 sm:p-8 md:p-12">
              {!mounted ? (
                ...
                <form
                  ...
                  aria-label="Formulario de contacto ALDECOA 360"
                >
                      ...
                      >
                        {filteredServices.length > 0 ? (
                          ...
                          <li
                            role="option"
                            aria-selected={false}
                            className="px-4 py-3 text-white/60 text-sm"
                          >
